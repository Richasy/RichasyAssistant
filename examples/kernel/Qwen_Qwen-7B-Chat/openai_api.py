...
async def create_chat_completion(request: ChatCompletionRequest):
    ...
    return ChatCompletionResponse(
        model=request.model, choices=[choice_data], object="chat.completion", usage=usage
    )
...
if __name__ == "__main__":
    ...
    try:
        ...
        uvicorn.run(app, host=args.server_name, port=port, workers=1)
    except Exception as e:
        print(e)
        log_launch_info(Status.ERROR, message='QWen launch failed')
